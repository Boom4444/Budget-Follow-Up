  ...
  persist(
    (set, get) => ({
      ...
      loadDemoData() {
        ...
        const rows: RawEntry[] = [
          // ── Janvier 2026 ─────────────────────────────────────────────────────
          ['2026-01-01', 'UBS', 'revenus',    'Salaire',            'credit', 7814,   'CHF', false, 'Pictet',                   'person1', ''],
          ...
          ['2026-01-07', 'CIC', 'revenus',    'Remboursement global','credit', 300,   'EUR', false, 'Angèle',                   'person1', 'Remboursement crédit (dernier pour la voiture)'],
          ...
          ['2024-06-24', 'CS',    'revenus',   'Salaire',            'credit', 6418.90,'CHF', false, 'EY',                       'person1', 'Salaire juin 2024'],
        ...
        const recurring: RecurringExpense[] = [
          { id: uuid(), title: 'LCL',      category: 'autre',      subCategory: 'Prêt',                    amount: 535.67, currency: 'EUR', isFixed: true,  bank: 'LCL',    person: 'person1', frequency: 'monthly' },
