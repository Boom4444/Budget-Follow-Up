    ...
    (set, get) => ({
      ...
      loadDemoData() {
        ...
        const rows: RawEntry[] = [
          ...
          ['2026-01-05', 'UBS', 'entreprise', 'Restaurant Travail','debit',   12,    'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ['2026-01-05', 'UBS', 'entreprise', 'Restaurant Travail','debit',    2.30, 'CHF', false, 'Pictet',                   'person1', 'Fruit petit déjeuner'],
          ['2026-01-06', 'UBS', 'entreprise', 'Restaurant Travail','debit',   12,    'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ...
          ['2026-01-07', 'UBS', 'nourriture', 'Autres Nourriture','debit',   27.20, 'CHF', false, 'Aux Merveilleux de Fred',  'person1', 'Petit-déjeuner anniversaire'],
          ['2026-01-07', 'UBS', 'entreprise', 'Restaurant Travail','debit',   25,    'CHF', false, 'Pictet',                   'person1', 'Repas + consigne Tupperware'],
          ['2026-01-08', 'CIC', 'banque',     'Frais Carte',      'debit',    5.47, 'EUR', false, 'CIC',                      'person1', ''],
          ['2026-01-08', 'Revolut','loisirs',  'Autres Loisirs',   'debit',   25.90, 'CHF', false, 'Meta Pay',                 'person1', '1er jeu avec Oculus'],
          ['2026-01-08', 'Revolut','besoinsPersonnels','Livres/Education','debit',80,'CHF', false, 'Apple',                    'person1', 'CISSP Renouvellement questions 6 mois'],
          ['2026-01-08', 'UBS', 'entreprise', 'Restaurant Travail','debit',   22,    'CHF', false, 'Pictet',                   'person1', 'Repas + consigne Tupperware'],
          ...
          ['2026-01-09', 'UBS', 'entreprise', 'Restaurant Travail','debit',   12,    'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ...
          ['2026-01-12', 'UBS', 'entreprise', 'Restaurant Travail','debit',   10.05, 'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ['2026-01-12', 'UBS', 'entreprise', 'Restaurant Travail','debit',    8,    'CHF', false, 'Pictet',                   'person1', 'Petit-déjeuner'],
          ['2026-01-12', 'UBS', 'entreprise', 'Restaurant Travail','credit',  15,    'CHF', false, 'Pictet',                   'person1', 'Retour consignes repas'],
          ['2026-01-13', 'CIC', 'cadeaux',    'Famille',          'debit',  200,    'EUR', false, 'La Poste',                 'person1', 'Retrait cash anniversaire Léna'],
          ['2026-01-13', 'UBS', 'entreprise', 'Restaurant Travail','debit',   12,    'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ...
          ['2026-01-15', 'UBS', 'entreprise', 'Restaurant Travail','debit',   17.80, 'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ...
          ['2026-01-16', 'UBS', 'entreprise', 'Restaurant Travail','debit',   12.05, 'CHF', false, 'Pictet',                   'person1', 'Repas'],
          ['2026-01-16', 'UBS', 'entreprise', 'Restaurant Travail','debit',    3.35, 'CHF', false, 'Pictet',                   'person1', 'Fruit petit déjeuner'],
          ['2026-01-16', 'UBS', 'entreprise', 'Restaurant Travail','credit',  25,    'CHF', false, 'Pictet',                   'person1', 'Retour consignes repas'],
          ...
          ['2024-06-01', 'Revolut','besoinsPersonnels','Livres/Education','debit',34.94,'EUR',false,'Les Arts Frontières',     'person1', 'Achat BD + Tome 13 Solo Leveling'],
          ...
          ['2024-06-03', 'CS',    'entreprise','Restaurant Travail','debit',  31.80, 'CHF', false, 'Umamido',                  'person1', ''],
          ['2024-06-04', 'CS',    'entreprise','Transport Travail','debit',   78.50, 'CHF', false, 'CFF',                      'person1', 'Train Zurich-Genève retour panel'],
          ['2024-06-04', 'CS',    'entreprise','Restaurant Travail','debit',  18,    'CHF', false, 'Suweena Fine Thai Food',   'person1', 'Pad Thai bureau Zurich'],
          ...
          ['2024-06-05', 'CS',    'entreprise','Restaurant Travail','credit', 204.80, 'CHF', false, 'EY',                      'person1', ''],
          ['2024-06-04', 'CIC',   'abonnements','Spotify',          'debit',   14.99, 'EUR', false, 'Spotify',                 'person1', ''],
          ['2024-06-05', 'CIC',   'besoinsPersonnels','Autres Besoins','debit',33.98,'EUR',false, 'Amazon',                   'person1', ''],
          ['2024-06-07', 'CS',    'entreprise','Restaurant Travail','debit',   17,    'CHF', false, 'Satay Sarray',             'person1', ''],
          ['2024-06-10', 'CS',    'entreprise','Restaurant Travail','debit',   16.90, 'CHF', false, 'Genecand Traiteur',        'person1', ''],
          ...
          ['2024-06-15', 'Revolut','nourriture','Autres Nourriture','debit',    3.50, 'CHF', false, 'Speciality Coffee',        'person1', 'Café Lyon'],
          ['2024-06-16', 'Revolut','nourriture','Restaurant',       'debit',    7.20, 'CHF', false, 'DiVoglia',                 'person1', 'Café moulu'],
          ['2024-06-17', 'CS',    'entreprise','Restaurant Travail','debit',   11.90, 'CHF', false, 'Migros',                   'person1', ''],
          ['2024-06-17', 'CIC',   'loisirs',   'Autres Loisirs',   'debit',    1.99, 'EUR', false, 'Amazon',                   'person1', ''],
          ['2024-06-17', 'CIC',   'transport', 'SNCF',             'debit',   18.60, 'EUR', false, 'SNCF',                     'person1', ''],
          ['2024-06-17', 'CIC',   'nourriture','Restaurant',        'credit',  38,    'EUR', false, 'Angèle',                   'person1', 'Remboursement restaurants Angèle'],
          ['2024-06-18', 'Revolut','cadeaux',  'Angèle',           'debit',  200,    'CHF', false, 'Léna Fournier',            'person1', 'Tapis de course Angèle'],
          ...
          ['2024-06-20', 'CIC',   'cadeaux',   'Angèle',           'debit',   94.60, 'EUR', false, 'Fever',                    'person1', 'CandleLight Cathédrale Fourvière anniversaire Angèle'],
          ['2024-06-23', 'Revolut','nourriture','Autres Nourriture','debit',   13.80, 'CHF', false, 'New York Coffee',          'person1', ''],
          ...
          ['2024-06-24', 'Revolut','transport', 'Autres Transport', 'debit',    4,    'EUR', false, 'Cumul',                    'person1', 'Péage vacances Italie'],
          ['2024-06-24', 'Revolut','nourriture','Restaurant',        'debit',    6,    'EUR', false, 'Gelateria Vernazza',       'person1', 'Glaces avec Quentin et Alex'],
          ['2024-06-24', 'Revolut','transport', 'SNCF',             'debit',   30,    'EUR', false, 'Trenitalia',               'person1', 'Trains Cinque Terre'],
          ['2024-06-24', 'Revolut','nourriture','Autres Nourriture','debit',    3.60, 'EUR', false, 'Sadyra Srls',              'person1', 'Café'],
          ['2024-06-24', 'CIC',   'transport', 'Autres Transport',  'debit',    4.40, 'EUR', false, 'Autoroute',                'person1', ''],
          ['2024-06-24', 'CIC',   'transport', 'SNCF',             'debit',    6.80, 'EUR', false, 'SNCF',                     'person1', ''],
          ['2024-06-24', 'CIC',   'transport', 'Autres Transport',  'debit',    4.40, 'EUR', false, 'Autoroute',                'person1', ''],
          ['2024-06-24', 'CIC',   'loisirs',   'Activité/Sortie',  'debit',  187,    'EUR', false, 'Grand Parc Puy Du Fou',    'person1', 'Puy Du Fou avec Angèle et Jacky'],
          ['2024-06-25', 'CIC',   'transport', 'Autres Transport',  'debit',   14.30, 'EUR', false, 'Autoroute',                'person1', ''],
          ...
          ['2024-06-26', 'Revolut','nourriture','Autres Nourriture','debit',    3.60, 'EUR', false, 'Melissa Coffee',           'person1', ''],
          ['2024-06-26', 'Revolut','nourriture','Autres Nourriture','debit',    6,    'EUR', false, 'Mokita Lounge',            'person1', ''],
          ['2024-06-26', 'Revolut','transport', 'Autres Transport', 'debit',   15.30, 'EUR', false, 'Autostrade per l\'Italia', 'person1', 'Péage Italie'],
          ...
          ['2024-06-28', 'Revolut','transport', 'Autres Transport', 'debit',    1.10, 'EUR', false, 'Vinci Autoroutes',         'person1', ''],
          ...
          ['2024-06-29', 'Revolut','transport', 'Autres Transport', 'debit',   12.90, 'EUR', false, 'APRR',                     'person1', ''],
