...
export default function SettingsScreen() {
  const { settings, updateSettings, loadDemoData, expenses } = useStore()
        ...
        <div className="card mx-4 overflow-hidden">
          {expenses.length > 0 ? (
            <div className="px-4 py-3">
              ...
              <p className="text-[12px] text-gray-400 mt-0.5">Les données sont stockées localement sur votre appareil</p>
            </div>
          ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40">
          <div className="bg-white rounded-t-3xl w-full p-6"
            ...
            <p className="text-[14px] text-gray-500 text-center mb-6">
              Ceci va charger 6 mois de dépenses exemples pour un foyer de 2 personnes.
            </p>
